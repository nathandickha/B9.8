    ...
    for (let i = 0; i <= segments; i++) {
      ...
      if (outside && arcStart === null) {
        ...
        if (arcEnd - arcStart > 0.01) {
          ...
          addCircularChannelExtrude(group, band, copingDepth, copingUnderZ, center, quat, copingMat);
        }
        arcStart = null;
      }
    }
...
// --------------------------------------------------------
export function updateGroundVoid(ground, poolGroup, spaGroup = null, options = {}) {
