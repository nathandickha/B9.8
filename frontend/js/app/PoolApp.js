    ...
    if (!this.transformControls) {
      ...
      this.transformControls.addEventListener("change", () => {
        if (this.spa && this.poolGroup) {
          updatePoolWaterVoid(this.poolGroup, this.spa);
          const previewOnly = !!this.transformControls?.dragging;
          updateGroundVoid(this.ground || this.scene?.userData?.ground, this.poolGroup, this.spa, { previewOnly });
        }
      });
  ...
  setupSpaSliders() {
    ...
    ["spaLength", "spaWidth", "spaTopHeight"].forEach((id) => {
      ...
      slider.addEventListener("input", (e) => {
        ...
        applySpaSliderValue(val);
        updateSpa(this.spa);
        this.refreshSpaTopOffsetSlider();
        if (this.poolGroup) {
          updatePoolWaterVoid(this.poolGroup, this.spa);
          updateGroundVoid(this.ground || this.scene?.userData?.ground, this.poolGroup, this.spa, { previewOnly: true });
        }
      });
